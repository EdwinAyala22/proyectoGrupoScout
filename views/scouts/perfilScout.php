...
<div class="container bg-light pt-5 px-5 pb-2 containerCrud mb-5">
    <div class="row">
        <h1 class="titulo fw-bold text-center mb-4" id="perfil">Perfil Scout</h1>
    </div>
    ...
    <div class="modal fade" id="cambiarContra<?php echo $sid ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="/proyectoGrupoScout/queries/cambiarContra.php?id=<?php echo $sid ?>" method="POST">
                        <div class="row">
                            <div class="">
                                <label for="contrasena" class="form-label fw-bold titulo">Contraseña anterior: </label>
                                <input id="contrasena" type="password" class="form-control mb-3 fw-bold input_login" name="contrasena" title="Contraseña anterior" required>
                            </div>
                            <div class="">
                                <label for="nuevaContrasena" class="form-label fw-bold titulo">Nueva contraseña: </label>
                                <input id="nuevaContrasena" type="password" class="form-control mb-3 fw-bold input_login" name="nuevaContrasena" title="Nueva contraseña" required >
                            </div>
                            <div class="">
